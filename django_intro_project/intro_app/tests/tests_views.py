...
class ProductApiTest(APITestCase):
    ...
    def test_delete_invalid_pk_product(self):
        self.token = str(AccessToken.for_user(self.admin))
        self.client.credentials(HTTP_AUTHORIZATION=f'Bearer {self.token}')
    ...
    def test_invalid_endpoint_get_product_nonexistent_pk_for_regular_user(self):
        self.token = str(AccessToken.for_user(self.regular_user))
        self.client.credentials(HTTP_AUTHORIZATION=f'Bearer {self.token}')
    ...
    def test_invalid_endpoint_get_product_nonexistent_pk_for_admin(self):
        self.token = str(AccessToken.for_user(self.admin))
        self.client.credentials(HTTP_AUTHORIZATION=f'Bearer {self.token}')
    ...
    def test_invalid_endpoint_get_product_with_invalid_pk_for_admin(self):
        self.token = str(AccessToken.for_user(self.admin))
        self.client.credentials(HTTP_AUTHORIZATION=f'Bearer {self.token}')
